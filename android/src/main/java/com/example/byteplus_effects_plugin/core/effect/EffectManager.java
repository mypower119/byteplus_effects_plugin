...
public class EffectManager {
   ...
   public int init(){
       ...
       try {
        ...
        String filePath = mLicenseProvider.getLicensePath();
        ...
        int ret = mRenderManager.init(mContext, mResourceProvider.getModelPath(), filePath, USE_PIPELINE, onlineLicenseFlag, renderapi);
